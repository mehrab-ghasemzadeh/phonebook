    ...
    <div class="addNewOverlay fixed top-0 left-0 w-svw h-svh flex justify-center items-center">
        <section class="bg-white p-5 rounded-xl">
            <div class="flex flex-col gap-3">
                <input class="w-full border border-[#d9d9d9] rounded-md p-3" type="text" id="newContactName" placeholder="name" v-model="newContact.name">
                <input class="w-full border border-[#d9d9d9] rounded-md p-3" type="mail" id="newContactemail" placeholder="e-mail" v-model="newContact.email">
