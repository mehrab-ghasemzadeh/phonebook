<template>
    <div id="header" class="border-b border-[#d9d9d9] w-full p-5 rounded-b-xl flex flex-row-reverse justify-between sticky top-0 bg-white shadow-xl z-[999]">
        ...
        <div v-if="searchState" class="flex gap-3 items-center">
            ...
            <input class="w-48 sm:w-64 border border-[#d9d9d9] rounded-md px-1" type="text" v-model="store.searchPrompt" @keyup.esc="searchState = !searchState">
